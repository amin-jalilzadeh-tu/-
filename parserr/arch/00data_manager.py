...
class EnhancedHierarchicalDataManager:
    ...
    def save_existing_outputs(self, existing_data: pd.DataFrame):
        """Save details of existing/found outputs"""
    ...
    def get_output_coverage_summary(self) -> Dict[str, Any]:
        ...
        # ADD THIS - Get most commonly existing outputs
        ...
        # ADD THIS - Get available outputs summary
    ...
    def save_transformed_timeseries(self, data: pd.DataFrame, data_type: str,
        ...
        """Save transformed timeseries data (semi-wide format)"""
        if data.empty:
            return
        
        # data_type is 'base' or 'variants'
    ...
    def load_raw_timeseries(self, category: str, frequency: str, year: int = None) -> pd.DataFrame:
        """Load raw timeseries data for a specific frequency"""
